...
//    public static final String TAG = "KalmanLocationService";
    ...
    class SensorDataEventLoopTask extends AsyncTask {
        ...
        void onLocationChangedImp(Location location) {
            ...
            Log.d("phonetracker", "onLocationChanged");
...
//                Log.d("phonetracker", "onLocationChanged");
    ...
    public void start() {
        ...
        TrackerSettings trackerSettings = TrackerSharedPreferences.load(KalmanLocationService.this, TrackerSettings.class);
        awsIot = new AwsIot(KalmanLocationService.this,"", trackerSettings.getAwsIotSettings());
